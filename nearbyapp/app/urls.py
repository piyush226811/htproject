...
urlpatterns = patterns('',
    ...
    url(r'^bookmark_movies/set/(?P<fbid>\w+)/(?P<theater>\w+)/', 'app.views.theatre_bookmark_set'),
    url(r'^bookmark_movies/unset/(?P<fbid>\w+)/(?P<theater>\w+)/', 'app.views.theatre_bookmark_unset'),
